...
/*
We have already looked at Vector and Iterators. You can go back to review
those if you are still unfamiliar with them. This lecture will discuss 3 more
similar containers List, Queue, and Stack
/*
...
/*
List implements the following member functions. This is not the complete
list, you will need to look up other functions for different uses.
*/
...
/*
 ...
 LIFO context (last-in first-out), where elements are inserted and extracted
 ...
 or some other specifically designed container class. The container shall

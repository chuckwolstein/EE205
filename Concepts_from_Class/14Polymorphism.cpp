...
when there is a hierarchy of classes and they are related by inheritance. There
are other types of polymorphism besides inheritance. We can also consider
function overloading and templates/generics also types of polymorphism.
*/
...
call is fixed before the program is executed. This is also sometimes called
early binding because the area() function is set during the compilation of the
program.
...
We've discussed pure virtual functions and abstract classes before when we
